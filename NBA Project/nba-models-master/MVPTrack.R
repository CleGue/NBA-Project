...
for (year in YEAR_START:YEAR_END) {
  str<-paste("champion/nba-models-master/award-stats/",year,".csv",sep="")
...
for (year in YEAR_START:YEAR_END) {
  # read data
  str<-paste("champion/nba-models-master/season-standings/",year,".csv",sep="")
...
for (year in YEAR_START:YEAR_END) {
  # read data
  str<-paste("champion/nba-models-master/season-stats-totals/",year,".csv",sep="")
  dat_temp<-read.csv(str, header = TRUE)
...
for (year in YEAR_START:YEAR_END) {
  # read data
  str<-paste("champion/nba-models-master/season-stats-pergame/",year,".csv",sep="")
  dat_temp<-read.csv(str, header = TRUE)
